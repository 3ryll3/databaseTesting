...
function removeAddBtn() {
    ...
    let addBtnBody = addBtn.parentElement;
    navbar.removeChild(addBtnBody);
}

function returnAddBtn() {
    const addBtn = `
    <li><button class="btn btn-add"><i class="fas fa-user-plus"></i></button></li>
    `;
    navbar.insertAdjacentHTML('beforebegin', addBtn);
}
